...
class ProductDetail extends Component {
  ...
  btnAddClick(e) {
    ...
    const name = txtName;
    const price = parseInt(txtPrice, 10); // Ensure price is an integer
    const category = cmbCategory;
    const image = imgProduct.replace(/^data:image\/[a-z]+;base64,/, ''); // remove "data:image/...;base64,"
  
    // Check for name, price, category, and image when adding a new product
